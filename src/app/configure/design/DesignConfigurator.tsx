...
import {
  ...
  MATERIALS,
  MODELS,
} from "@/validators/option-vatidator";
...
const DesignConfigurator = ({
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      <div className="h-[37.5rem] flex-col flex bg-white w-full col-span-full lg:col-span-1">
                    ...
                    {COLORS.map((color) => (
                      <RadioGroup.Option
                        ...
                        className={({ active, checked }) =>
                          cn(
                            "border-2 border-transparent relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 active:ring-0 focus:ring-0 active:outline-none focus:outline-none",
                            {
                ...
                {[MATERIALS, FINISHES].map(
                  ({ name, options: selectableOptions }) => (
                    <RadioGroup
                      key={name}
                      value={options[name]}
                      // name can be both material or finish
                      onChange={(val) => {
